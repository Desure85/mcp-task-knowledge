...
## Market Research (Sprint Planning)

> Исследование проведено 2026-04-04. Подробности: `MARKET-RESEARCH.md`.

**Ключевые выводы:**
- 7,200+ MCP-серверов в экосистеме, ни один не покрывает task + knowledge + prompts + A/B
- Наш проект — **единственный** с таким набором фич
- Top-3 боли: (1) нет auth, (2) production readiness, (3) token overhead
- 4 критических гэпа, 2 из которых мы уже закрываем

**Приоритизированные спринты (заменяют линейный порядок этапов):**

| Sprint | Фокус | Ключевые задачи | Срок (оценка) |
|--------|-------|----------------|---------------|
| 1 | Foundation + Observability | F-001, F-004, F-007, Q-001..003 | 2-3 недели |
| 2 | Auth + Rate Limiting | A-002, S-001, S-003, F-002, T-001 | 2-3 недели |
| 3 | Quality + UX | Q-004, Q-005, D-005, D-001 | 2 недели |
| 4 | Web UI MVP | W-001..W-002 | 3-4 недели |

Отложены: Proxy (5), Sync (6), Scalability (10), gRPC (11), Smart features (12).
...
|------|-----------|-------|
| 2026-04-04 | Добавлено исследование рынка, спринт-планирование, новые задачи (F-007..009) | agent |
